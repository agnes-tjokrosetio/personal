...
export const relevantSkills = [
  ...
  {
    type: "Databases",
    details: ["MySql", "PostgreSQL", "SQLite", "psycopg2"],
  },
  {
    type: "Software Engineering",
    details: ["Object Oriented Programming", "Testing"],
  },
  {
...
export const relevantCourses = [
  ...
  {
    degree: "Computer Science",
    course: "Mathematics 1B (MATH1231)",
    mark: "92 HD",
  },
  {
    degree: "Computer Science",
    course: "Discrete Mathematics (MATH1081)",
    mark: "86 HD",
  },
  {
    degree: "Finance",
...
export const interestAreas = [
  {
    icon: "fa-music",
    label: "Composing instrumental music",
  },
  {
    icon: "fa-hand-o-right",
    label: "Tennis and gym",
  },
  {
    icon: "fa-map-marker",
    label: "Travelling",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Students nowadays are unwilling to leave their classes or study areas to get food. Businesses missing out on potential revenue from student customers. As part of a team, we built this application to allow students to order from restaurants around campus to their specific room at uni. Application was built as a cross-platform app using Expo. Implemented a PostgreSQL database with Prisma and developed the backend and authentication system using Express.",
